      ...
      <div className="sr pad space">
        <div className="left">
          ...
          <motion.svg
            ...
            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-tools" viewBox="0 0 16 16">
        ...
        <div className="right">
          ...
          <motion.svg
            ...
            transition={{ type: 'spring', duration: 1.4 }}
            xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-file-text-fill" viewBox="0 0 16 16">
